<template>
  <el-container :style="{height:windowHeight - 100+'px'}">
    <el-main>
      <el-row :gutter="20">
        <el-col :xs="24" :sm="24" :lg="leftCol">
          <el-card :style="{height:windowHeight - 140+'px'}">
            <div v-if="is_solo" style="padding: 10px">
              <el-popover
                trigger="manual"
                placement="bottom"
                title="运行次数"
                ...
                content="变换检测已运行次数"
              >
               <span slot="reference" style="position: fixed;float: left;display: inline;left: 100px">
                <el-tag>本站已运行：{{ bhjc_nums }}次</el-tag>
              </span>
              </el-popover>
              <el-popover
                trigger="manual"
              ...
              >
                        <span slot="reference">
                            <h1 style="display: inline">变 换 检 测</h1>
                        </span>
              </el-popover>


              <div style="position: fixed;float: right;display: inline;right: 100px">
                <el-popover
                  v-if="bhjc_img_list_results === null || bhjc_img_list_results[0] === undefined"
                  trigger="manual"
                  placement="bottom"
                  title="运行"
                  width="200"
                  style="z-index: 999"
                  v-model="showHelp"
                  content="点击按钮开始检测图1和图2的变化"
                >
                        <span slot="reference">
                          <el-button type="success" @click="detect(bhjc_img_list[0])"><i
                ...
                >
                        <span slot="reference">
                          <el-button type="success" @click="downloadByUrl(bhjc_img_list_results[0],'download')"><i
              ...
              <el-row :gutter="40">
                <el-col :xs="24" :sm="12" :lg="12">
                  <el-card class="card_style" :body-style="{ height:windowHeight - 280+'px' }" style="overflow: auto">
                    <div
                      v-if="bhjc_img_list === null || bhjc_img_list[0] === undefined || bhjc_img_list[0].img1 === undefined"
                      class="centerVertically"
                    >
                      <div style="padding: 14px;">
                        <span style="font-size: 25px">变化前图</span>
                      </div>
                      <el-popover
                        trigger="manual"
                        placement="left"
                    ...
                    <div v-else style="overflow: auto">
                      <span>
                        <el-image
                          :preview-src-list="[bhjc_img_list[0].img1]"
                          :style="{height:windowHeight - 310+'px'}"
                          :src="bhjc_img_list[0].img1"
                          fit="fill"
                        ></el-image>
                      </span>
                    </div>
                ...
                <el-col :xs="24" :sm="12" :lg="12">
                  <el-card class="card_style" :body-style="{ height:windowHeight - 280+'px'}" style="overflow: auto">
                    <div
                      v-if="bhjc_img_list === null || bhjc_img_list[0] === undefined || bhjc_img_list[0].img2 === undefined"
                      class="centerVertically"
                    >
                      <div style="padding: 14px;">
                        <span style="font-size: 25px">变化后图</span>
                      </div>
                      <el-popover
                        trigger="manual"
                        placement="right"
                      ...
                      >
                        <span slot="reference">
                          <el-upload class="avatar-uploader" :action="imagesUploadApi" :show-file-list="false"
                                     ...
                                     :on-success="(value)=> uploadSuccess_solo2(value)"
                          >
                            <i class="el-icon-plus avatar-uploader-icon"></i>
                          </el-upload>
                          <el-progress v-if="progressStatus2" :text-inside="true" :stroke-width="26"
                    ...
                    <div v-else style="overflow: auto">
                      <el-image
                        :preview-src-list="[bhjc_img_list[0].img2]"
                        :style="{height:windowHeight - 310+'px'}"
                        :src="bhjc_img_list[0].img2"
                        fit="fill"
                      ></el-image>
                    </div>
                  </el-card>
            ...
            <div v-else>
              <div slot="header" class="clearfix">
                <span style="font-size: 20px;text-align: center">变 化 检 测</span>
        ...
        <el-col :xs="24" :sm="24" :lg="rightCol">
          <el-card>
            <div slot="header" class="clearfix">
              <span>功 能</span>
            </div>
    ...
    <div v-show="soloTask" class="toBottom is_fixed_artwork" :style="activeStyleTop">
      <el-tooltip effect="dark" content="查看检测结果" placement="top">
        <el-popover
          trigger="manual"
          placement="top"
          title="结果"
        ...
        >
                        <span slot="reference">
                          <el-button type="primary" @click="handleShowResult">
                            检测结果
                          </el-button>
                        </span>
        </el-popover>
...
<script>
import Table from '@/views/system/user/components/Table'
