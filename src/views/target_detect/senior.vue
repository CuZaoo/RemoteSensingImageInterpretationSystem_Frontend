          ...
          <el-card :style="{height:windowHeight - 160+'px'}">
            <div>
              <div slot="header" class="clearfix">
                <span style="font-size: 20px;text-align: center">目 标 检 测</span>
              ...
              <el-row>
                <el-col>
                  <el-descriptions title="模型信息" :column="1">
                    ...
                    <el-descriptions-item label="AP">{{ nowModel.miou }}</el-descriptions-item>
...
import {
  getStatCount, recordPV, uploadPicture
  ...
  methods: {
    ...
    uploadFile(blob) {
      ...
      axios({
        ...
        console.log('res')
        console.log(res)
        this.$store.dispatch('set_img_to_mbjc', res.data.path)
