          ...
          <el-card :style="{height:windowHeight - 160+'px'}">
            <div>
              <div slot="header" class="clearfix">
                <span style="font-size: 20px;text-align: center">目 标 提 取</span>
        ...
        <el-col :xs="24" :sm="24" :lg="4">
          <el-card>
            ...
            <div>
              ...
              <el-row>
                <el-col :xs="24" :sm="24" :lg="24">
                  <el-button type="success" icon="el-icon-s-promotion" plain style="width:100%" @click="handleRunAll">
                    全部运行
                  </el-button>
                </el-col>
              </el-row>
  ...
  methods: {
    ...
    uploadFile(blob) {
      ...
      axios({
        ...
        console.log('res')
        console.log(res)
        this.$store.dispatch('set_img_to_mbtq', res.data.path)
