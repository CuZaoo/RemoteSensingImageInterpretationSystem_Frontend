<template>
  <el-container :style="{height:windowHeight - 100+'px'}">
              ...
              <el-row :gutter="20" type="flex" class="row-bg" justify="center">
                <el-col :span="6" :xs="2" :sm="2" :lg="2">
                  <el-popover
                    ...
                    title="运行"
                    width="200"
                    style="z-index: 999;padding: 0 40px"
                    v-model="showHelp"
                ...
                <el-col :xs="2" :sm="2" :lg="2">
                  <el-button type="danger" @click="del_img_solo_all"><i class="el-icon-delete"></i> 删除图片
                  </el-button>
                </el-col>
                <el-col :xs="2" :sm="2" :lg="2">
                  <el-popover
    ...
    <!--    <div class="toBottom is_fixed_artwork" :style="activeStyleTop">-->
